...
abstract class TaskManagerTest<T extends TaskManager> {
    ...
    @Test
    void removeTaskById() {
        Task task1 = new Task("Test task1", "Test task1 description", Status.NEW, LocalDateTime.now(), Duration.ofMinutes(5));
        Task task2 = new Task("Test task2", "Test task2 description", Status.NEW, LocalDateTime.now().minusHours(1), Duration.ofMinutes(5));
    ...
    void removeSubTaskById() {
        ...
        taskManager.addEpic(epic1);
        taskManager.addEpic(epic2);
        SubTask subTask1 = new SubTask("Test subTask1", "Test subTask1 description", epic1.getId(), Status.IN_PROGRESS, LocalDateTime.now(), Duration.ofMinutes(5));
        SubTask subTask2 = new SubTask("Test subTask2", "Test subTask2 description", epic2.getId(), Status.IN_PROGRESS, LocalDateTime.now().minusHours(1), Duration.ofMinutes(5));
        taskManager.addSubTask(subTask1);
        taskManager.addSubTask(subTask2);
    ...
    //Почему-то выдает, что исключения нет, при дебаге исключение есть
    @Test
    void testException() {
        Task task = new Task("Test task", "Test task description", Status.NEW, LocalDateTime.now(), Duration.ofMinutes(5));
        taskManager.addTask(task);
